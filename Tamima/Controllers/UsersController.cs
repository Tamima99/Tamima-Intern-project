...
namespace Tamima.Controllers
{
    public class UsersController : Controller
    {
        private readonly TamimaContext _context;

        public UsersController(TamimaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'TamimaContext.User'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TamimaContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
